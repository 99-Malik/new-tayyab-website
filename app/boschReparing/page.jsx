    ...
    <div className="mt-[-10px]">
        ...
        >
          ...
          <div>
            <h1 className="text-4xl  font-raleway text-white leading-tight">
              ...
              <span>Bosch Appliances Service Center</span>
            </h1>
            <p className=" text-md py-5 font-raleway text-white">
              Repair Home UAE is a Bosch Service Centre in Dubai
              and Abu Dhabi. Trust our well-trained technicians to deliver
              professional & reliable Bosch repairs ensuring your appliances
              are in capable hands.Bosch Dishwasher Repair, Dryer,Washing
              Machine,LED TV, Microwave and Refrigerator Repair.All Bosch
              Reparing Services.
            </p>
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              ...
              <p className="py-12 text-md px-4 font-semibold text-white">
                ...
                Bosch,Bosch,Bosch,Bosch and Whirlpool appliances
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-4xl font-bold max-w-xl">
              Welcome To Repair Home UAE Bosch Service Center
            </h1>
            ...
            <p className="py-6 max-w-xl">
              Bosch Service Center Dubai is dedicated to providing
              high-quality service and repairs of Bosch kitchen appliances. We
              ...
              and commercial customers. With our reliable Bosch service center
              ...
              to ensure complete customer.Bosch appliance repair Bosch
              appliance service Bosch appliance technician Bosch appliance
              maintenance Bosch appliance fix Bosch refrigerator repair
              Bosch washer and dryer repair Bosch dishwasher repair Bosch
              oven and stove repair Bosch microwave repair Bosch TV repair
              Bosch air conditioner repair Bosch freezer repair Bosch
              range hood repair Bosch small appliance repair
            </p>
      ...
      <div className="hero min-h-screen bg-base-100">
          <div className="hero-content flex-col lg:flex-row">
            <div>
              <h1 className="text-4xl font-bold">Bosch Service Center Abu DHabi</h1>
              <p className="py-6">
                We provide Bosch Service Center in Abu Dhabi.The
                best Bosch Service Center in Abu Dhabi.We provide
                following services:
              </p>
              <ul>
            ...
            <div>
              <h1 className="text-4xl mt-2 font-bold">Bosch Service Center Dubai</h1>
              <p className="py-6">
                We provide Bosch Service Center in Dubai. The best Bosch
              ...
              <div className="card-body bg-[#2c2a2a]">
                ...
                <div className="sm:w-[170px] text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    performance of Bosch dishwasher. Our Dishwasher Repair Service is your
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#2c2a2a]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    "Delivering top-tier, professional solutions that ensure the
                    optimal performance of your Bosch gas cooker/stove. Our Gas Cooker/Stove Repair
