    ...
    <div className="mt-[-10px]">
        ...
        >
          ...
          <div>
            <h1 className="text-4xl  font-raleway text-white leading-tight">
              ...
              <span>Siemens Appliances Service Center</span>
            </h1>
            <p className=" text-md py-5 font-raleway text-white">
              Repair Home UAE is a Siemens Service Centre in Dubai
              and Abu Dhabi. Trust our well-trained technicians to deliver
              professional & reliable Siemens repairs ensuring your appliances
              are in capable hands.Siemens Dishwasher Repair, Dryer,Washing
              Machine,LED TV, Microwave and Refrigerator Repair.All Siemens
              Reparing Services.
            </p>
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              ...
              <p className="py-12 text-md px-4 font-semibold text-white">
                ...
                Siemens,Siemens,Bosch,Siemens and Whirlpool appliances
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-4xl font-bold max-w-xl">
              Welcome To Repair Home UAE Siemens Service Center
            </h1>
            ...
            <p className="py-6 max-w-xl">
              Siemens Service Center Dubai is dedicated to providing
              high-quality service and repairs of Siemens kitchen appliances. We
              ...
              and commercial customers. With our reliable Siemens service center
              ...
              to ensure complete customer.Siemens appliance repair Siemens
              appliance service Siemens appliance technician Siemens appliance
              maintenance Siemens appliance fix Siemens refrigerator repair
              Siemens washer and dryer repair Siemens dishwasher repair Siemens
              oven and stove repair Siemens microwave repair Siemens TV repair
              Siemens air conditioner repair Siemens freezer repair Siemens
              range hood repair Siemens small appliance repair
            </p>
      ...
      <div className="hero min-h-screen bg-base-100">
          <div className="hero-content flex-col lg:flex-row">
            <div>
              <h1 className="text-4xl font-bold">Siemens Service Center Abu DHabi</h1>
              <p className="py-6">
                We provide Siemens Service Center in Abu Dhabi.The
                best Siemens Service Center in Abu Dhabi.We provide
                following services:
              </p>
              <ul>
            ...
            <div>
              <h1 className="text-4xl mt-2 font-bold">Siemens Service Center Dubai</h1>
              <p className="py-6">
                We provide Siemens Service Center in Dubai. The best Siemens
              ...
              <div className="card-body bg-[#2c2a2a]">
                ...
                <div className="sm:w-[170px] text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    performance of Siemens dishwasher. Our Dishwasher Repair Service is your
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#2c2a2a]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    "Delivering top-tier, professional solutions that ensure the
                    optimal performance of your Siemens gas cooker/stove. Our Gas Cooker/Stove Repair
