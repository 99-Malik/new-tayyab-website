  ...
  const WrenchIcon = () =>
    ...
    >
      <path
        ...
        d="M15.232 5.232l3.536 3.536m-2.829-1.414a4 4 0 11-5.657 5.657L6 18H4v-2l7.071-7.071a4 4 0 015.657-5.657z"
      />
    </svg>;

  const services = [
    "Samsung Washing Machine Repair",
    "Samsung Refrigerator Service Centre",
    "Samsung Stove Service Centre",
    "Samsung Oven Service Centre",
    "Samsung Dryer Service Centre",
    "Samsung Dishwasher Service Centre",
    "Samsung Cooking range service center",
    "Samsung washer service center",
    "Samsung dubai service center",
    "Samsung service centre near me",
    "Samsung Cooker Repair service centre"
  ];
        ...
        >
          ...
          <div>
            ...
            <p className=" text-md text-center py-2 font-raleway text-white">
              NO.1 Samsung APPLIANCE REPAIR & SERVICE CENTER IN DUBAI and Abu
              Dhabi
            </p>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-2xl font-bold max-w-xl mt-2">
              Professional Samsung Service Centre Dubai and Abu Dhabi
            </h1>
            ...
            <p className="py-6 max-w-xl">
              Experienced Samsung technicians are available 24 hours a day, seven
              days a week, to service and repair your Samsung appliances. We
              provide the best Samsung kitchen appliance repair services at your
              doorstep, We offer same-day Samsung appliance repairs for
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <p className="py-6 text-black">
                Samsung Service Center in All Areas of the UAE, Specialized in All
                Brands That means you can hire us for any problem related to
                Samsung home appliances. Our service centre is specialized in all
                types of, including fully automatic, semi-automatic, front
                loading, top loading, compact, and combination units. Contact
                our experienced washing machine technicians in Dubai.iding our
        ...
        <div className="hero-content flex-col lg:flex-row">
          <div>
            <h1 className="text-xl font-semibold">
              Samsung SERVICE CUSTOMER SUPPORT DUBAI 24/7 Samsung CUSTOMER CARE
            ...
            <p>
              If you’re looking for an engineer to repair your Samsung washing
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    "Delivering top-tier, professional solutions that ensure the
                    optimal performance of your Samsung Fridge/Refrigerator
