...
const ContactPage = () => {
  ...
  return <div className="hero min-h-screen bg-[url(/images/backgrounds/2.jpg)] bg-fixed">
        ...
        <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-[#202020]">
          <div className="card-body">
            <div className="flex gap-3 flex-col">
              ...
              <a href={`tel:${phoneNumber}`} className="flex items-center gap-2 hover:scale-105 duration-300 cursor-pointer">
              ...
              <div className="flex items-center gap-2 hover:scale-105 duration-300 cursor-pointer">
                <a href={`//api.whatsapp.com/send?phone=${phoneNumber}&text=Hey, I want Home Appliance Repair Service.`} target="_blank" className="p-[0.9rem] bg-[#F8860D] rounded-full">
