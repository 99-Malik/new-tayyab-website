    ...
    <div className="mt-[-10px]">
        ...
        >
          ...
          <div>asher
            <h1 className="text-4xl  font-raleway text-white leading-tight">
              ...
              <span>
                Bosch Appliances Service Center a Best Stove/Cooking Range Repair
            ...
            <p className=" text-md py-5 font-raleway text-white">
              ...
              Bosch Stove/Cooking Range Repair Dubai. We offer our services 24/7. We
              are experts for Bosch Stove/Cooking Range Repair service in Duba and
              Abu Dhabi.{" "}
            </p>
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              <h1 className="text-2xl mt-3 md:mt-0 md:text-5xl font-bold text-[#F8860D]">
                "BOSCH Stove/Cooking Range REPAIR IN DUBAI AND ABU DHABI"
              </h1>
              <p className="py-12 text-lg px-4  text-white">
                Bosch stands out as a favored brand among the residents of
                Dubai, with{" "}
                <span className="text-lg text-[#F8860D] font-extrabold">
                  Bosch Stove/Cooking Range
                </span>{" "}
                finding their place in many households across the city.No matter
                what, no matter when: The Bosch Service Team is here for you. If
                you need help with your Bosch service Center, we have got you
                covered! Bosch Stove/Cooking Range use less water, energy and
                detergent. As per the Bosch Company, they state, 'Bosch washing
                ...
                you can always be sure that your Bosch Customer care is the best
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-3xl font-bold max-w-xl">
              ...
              Stove/Cooking Range Repair Service.
            </h1>
            ...
            <p className="py-6 text-md max-w-xl">
              <h1 className="text-lg font-bold max-w-xl">
                Appliance Fix AE in Dubai & Abu Dhabi offers guaranteed bosch
                Stove/Cooking Range repair. Our company is a quality conscious
                company, so we always provide guaranteed services. As our
                customers trust us so we never like to lose our trust.
              </h1>
              The Bosch Stove/Cooking Range entered the market almost four decades
              ago. The company emphasis bringing ease to the laundry with
              various new features as well as supporting washer-Stove/Cooking Range,
              polyester-spin cycle, non-stop programming and many more. Due to
              all of the innovative work, Bosch is regarded as one of the top
              Stove/Cooking Range brands in Dubai. And our company is treated as
              the most loved repairing company for Bosch Stove/Cooking Range Repair
              Dubai. So, always be the first to get our repair services. "Our
              team comprises extensively trained professionals who possess
              in-depth knowledge of Bosch Stove/Cooking Range standards.
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#002B3D]">
                <h2 className="card-title text-[#F8860D] hover:scale-110 font-bold duration-300 hover:cursor-pointer">
                  Bosch Stove/Cooking Range Repair
                </h2>
                <div className="sm:w-[200px] text-start text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    the optimal performance of your Bosch Stove/Cooking Range. Our
                    Stove/Cooking Range Repair Service is your reliable partner for
                    all your Stove/Cooking Range repair needs."
                  </p>
                </div>
      ...
      <div className=" w-full mb-4 md:mb-10 bg-black h-auto md:h-[500px] ">
        <div className="hero min-h-screen bg-[#fafafa]">
          <div className="hero-content  flex-col lg:flex-row-reverse">
            <img loading="lazy"
              src="/images/Stove/Cooking Range/2.jpg"
              className="sm:w-[full] md:max-w-sm sm:h-full md:px-0 px-5 ml-[-8px] md:ml-0  md:mx-0 rounded-xl drop-shadow-2xl"
            />
            <div>
              ...
              <p className="py-6 text-black">
                ...
                you're seeking budget-friendly Bosch Stove/Cooking Range Repair
        ...
        <div className="flex flex-wrap px-2 md:px-10 justify-center lg:justify-between items-center py-5 w-full max-w-6xl gap-1">
          ...
          <div className="stats shadow w-full mb-4 max-w-[280px] md:w-[250px] bg-[#171717]">
            <div className="stat place-items-center bg-[#171717] border-[3px] border-[#F8860D] rounded-2xl mt-2  md:mb-0 md:mt-0">
              ...
              <div className="stat-desc text-[#F8860D]">Fridge Repaired</div>
            </div>
          </div>
          <div className="stats shadow w-full max-w-[280px] md:w-[250px] bg-[#171717]">
