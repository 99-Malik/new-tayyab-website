...
const BoschPage = () => {
  const WrenchIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        ...
        <div className="hero-content flex-col-reverse lg:flex-row-reverse mt-20 md:mt-10" style={{ zIndex: 0 }}>
          ...
          <div>
            ...
            <p className=" text-md text-center py-2 font-raleway text-white">
              NO.1 BOSCH APPLIANCE REPAIR & SERVICE CENTER IN DUBAI and Abu
              Dhabi
            </p>
            ...
            <div>
              ...
              <p className="py-12 text-md px-4 font-semibold text-white">
                "We recognize the uniqueness of every repair task, which is why we offer tailor-made solutions designed to meet the specific requirements of our clients. <span className="text-lg text-[#F8860D] font-extrabold">
                  ...
                  interruptions
                </span>.Therefore, you can always rely on Bosch Customer Care as the ultimate destination for repairing your home appliances. Simply get in touch with us via a call or WhatsApp to schedule an appointment."
              </p>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-2xl font-bold max-w-xl mt-2">
              Professional BOSCH Service Centre Dubai and Abu Dhabi
            </h1>
            ...
            <p className="py-6 max-w-xl">
              Experienced Bosch technicians are available 24 hours a day,
              seven days a week, to service and repair your Bosch appliances.
              We provide the best Bosch kitchen appliance repair services at
              your doorstep, We offer same-day Bosch appliance repairs for
              dishwashers, refrigerators, dryers, and more.{" "}
            </p>
      ...
      <div className=" w-full bg-black h-auto md:h-[500px] ">
        <div className="hero min-h-screen bg-[#fafafa]">
          <div className="hero-content  flex-col lg:flex-row-reverse">
            ...
            <div>
              <h1 className="text-3xl mt-3 md:mt-0 md:text-5xl font-semibold text-base-content">
                Bosch Washing Machine Repair Service{" "}
              </h1>
              <p className="py-6 text-black">
                Bosch Service Center in All Areas of the UAE, Specialized in All Brands That means you can hire us for any problem related to Bosch home appliances. Our service centre is specialized in all types of, including fully automatic, semi-automatic, front loading, top loading, compact, and combination units. Contact our experienced washing machine technicians in Dubai.iding our clients with the highest quality of service.
                <div className="flex flex-col space-y-4 p-4">
                  {services.map((service, index) =>
                    <div key={index} className="flex items-center space-x-2">
                      <WrenchScrewdriverIcon className="w-6 h-6" />
      ...
      <div className="hero h-auto bg-base-100">
        <div className="hero-content flex-col lg:flex-row">
          <div>
            ...
            <p>
              If you’re looking for an engineer to repair your Bosch washing
              machine, then look no further. We are experts in washing machine
              fixing and provide excellent customer service. With years of
              experience in repairing all types of washers, we guarantee that
              you’ll be happy with your services.
            </p>
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[200px] text-start text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    guarantee the optimal performance of your Bosch washing
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    the optimal performance of your Bosch dryer. Our Dryer
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[170px] text-white  md:w-[500px] h-auto">
                  <p>
                    ...
                    optimal performance of Bosch dishwasher. Our Dishwasher
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    "Delivering top-tier, professional solutions that ensure
                    the optimal performance of your Bosch gas cooker/stove.
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl">
              ...
              <div className="card-body bg-[#002B3D]">
                ...
                <div className="sm:w-[200px] text-white  md:w-[500px] h-auto">
                  <p>
                    "Delivering top-tier, professional solutions that ensure
                    the optimal performance of your Bosch Fridge/Refrigerator
