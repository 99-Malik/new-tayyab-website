        ...
        >
          ...
          <div>
            <h1 className="text-4xl  font-raleway text-white leading-tight">
              ...
              <span>
                Bosch Appliances Service Center a Best Washing Machine Repair
            ...
            <p className=" text-md py-5 font-raleway text-white">
              ...
              Bosch Washing Machine Repair Dubai. We offer our services 24/7. We
              are experts for Bosch Washing Machine Repair service in Duba and
              Abu Dhabi.{" "}
            </p>
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              <h1 className="text-2xl mt-3 md:mt-0 md:text-5xl font-bold text-[#F8860D]">
                "BOSCH WASHING MACHINE REPAIR IN DUBAI AND ABU DHABI"
              </h1>
              <p className="py-12 text-lg px-4  text-white">
                ...
                covered! Bosch washing machines use less water, energy and
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            ...
            <p className="py-6 text-md max-w-xl">
              ...
              The Bosch washing machines entered the market almost four decades
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse">
            ...
            <div>
              ...
              <p className="py-6 text-black">
                ...
                you're seeking budget-friendly Bosch Washing Machine Repair
